...
job_configs = [ArgumentsConfig(config=config) for config in ["dp_rgb"]] # "mlp_rgb", "mlp_rgb_cnn", "mlp_rgb_r3m", "mlp_rgb_dinov2", "mlp_rgb_r3m_finetune", 
...
def job_fn(job_cfg: ArgumentsConfig):
    ...
    sys.argv = [
        ...
        "--name", f"{job_cfg.config}_nopad_v3",
